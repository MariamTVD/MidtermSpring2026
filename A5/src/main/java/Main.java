...
public class Main {
    ...
    static GameHistoryRepository historyRepository;
    static LocalDateTime currentGameStartedAt;
    ...
    public static void main(String[] args) {
        ...
        historyRepository = PersistenceManager.createRepository();
        ...
        LOGGER.info("Game session started with " + playerNames.size() + " players and " + games + " game(s).");
    ...
    static void printHelp() {
        ...
        System.out.println("java Main --history");
        System.out.println("java Main --wins");
        System.out.println("java Main --high-scores");
    }
    ...
    static void playGame() {
        currentGameStartedAt = LocalDateTime.now();
    ...
    static void scoreWinner(String name) {
        ...
        if (historyRepository != null) {
            ...
            LOGGER.info("Persisted completed game result for winner " + name + ".");
        }
    ...
    static void printRecentGames() {
        System.out.println("Recent games:");

        for (String row : historyRepository.listRecentGames(10)) {
            System.out.println(row);
        }
    }

    static void printPlayerWinCounts() {
        System.out.println("Player win counts:");

        for (String row : historyRepository.playerWinCounts()) {
            System.out.println(row);
        }
    }

    static void printHighestScores() {
        System.out.println("Highest scores:");

        for (String row : historyRepository.highestScores(10)) {
            System.out.println(row);
        }
    }
